...
import { PMGN, BadGameFileError } from "./pmgn";
    ...
    while (moveCount > 0) {
        ...
        if (
            ...
            if ( // ↑ elimizdeki son taşı bu kuyuya harcadıysak, (yukarıdan geliyor)
                ...
                applyMoveSeedMoveHandler(eventHandler, playerStoreIndex, board[moveIndex], moveIndex);
                board[moveIndex] = 0;
            ...
            if (// ↑ elimizdeki son taşı bu kuyuya harcadıysak, (yukarıdan geliyor)
                ...
                if (
                    ...
                    applyMoveSeedMoveHandler(eventHandler, playerStoreIndex, 1, moveIndex);
                    applyMoveSeedMoveHandler(eventHandler, playerStoreIndex, board[oppositePitIndex], oppositePitIndex);
